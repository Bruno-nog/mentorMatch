...
export default function Home() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-black-50 px-6 text-center">
      ...
      <div className="flex gap-4">
        ...
        <Link
          href="/login"
          className="border border-black px-12 py-3 rounded font-medium"
        >
          Log In
        </Link>
      </div>
